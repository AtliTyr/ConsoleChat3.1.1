...
void ChatMenu()
{
	...
	do
	{
		...
		case '1':
		{
			...
			command = command + " " + authUserLogin + " " + " " + " " + msg;
			...
			if (msg == "true")
				...
				cout << "error delivering message" << endl;
		...
		case '2':
		{
			...
			string recL = loginRequest();
			getline(cin, msg);

			command = command + " " + authUserLogin + " " + recL + " " + msg;
		...
		case '6':
		{
			...
			if (msg == "true")
				...
				cout << "account wasnt deleted" << endl;
